...
public class App {
    ...
    @Column(name = "nameApp",nullable = false,length = 20)
    ...
    public App(int idApp, String nameApp, Boolean stateApp, LocalDate implementationDateApp, double amountApp, String typeApp, String versionApp) {
        this.idApp = idApp;
